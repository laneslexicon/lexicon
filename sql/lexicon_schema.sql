...
CREATE TABLE entry (id integer primary key,datasource integer,root text,broot text,word text,bword text,itype text,nodeId text,xml text,supplement integer,file text,page integer,nodenum real, bareword text,perseusxml text);
